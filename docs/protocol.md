        # Kmcurve: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/kmcurve.git

        ## Objective

        KMCurve provides tools for Kaplan-Meier curve analysis and digitisation, supporting IPD reconstruction from published survival figures for meta-analytic use.
        ...
        - Code: https://github.com/mahmood726-cyber/kmcurve.git
